...
export default function Home() {
  ...
  return (
    <div className="relative w-screen flex flex-col items-center justify-center bg-darkGray">
      ...
      >
        <div id="Ayo" className="flex flex-col sm:flex-row min-h-screen items-center sm:space-x-10 justify-center py-[5rem] sm:py-[10rem]">
          <p className="text-[80px] sm:text-[100px] md:text-[140px] 2xl:text-[181.52px] opacity-50 font-bricolage text-white font-bold mb-4 sm:mb-0">Hi, i'm</p>
          <div
            id="ahyoh"
            ...
            >
              <div className="relative group">
                <Image
                  ...
                  width={142.95}
                  height={142.95}
                  className={`rounded-[27.23px] transition-all duration-800 border-[1px] ${isHovered ? 'sm:border-white' : 'border-transparent'}`}
                />
              </div>
            </motion.div>
            ...
            <div className="relative sm:pl-10">
              <div className="relative inline-block">
                <motion.p
                  ...
                  animate={{ color: isHovered && window.innerWidth > 640 ? hoverColor : 'white' }}
                  transition={{ duration: 0.8, ease: 'easeOut' }}
                >
                  Ayo
                </motion.p>
        ...
        <div id="Journey" ref={missionRef} className={`min-h-screen ${isMissionSticky ? 'sticky top-0 z-10' : ''}`}>
          <Mission />
        </div>

        <div id="blog" ref={ideasRef} className={`min-h-screen ${isIdeasSticky ? 'sticky top-0 z-20' : ''}`}>
          <Ideas />
        </div>
        <div id="contact">
          <Footer />
